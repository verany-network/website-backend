...
$('#map-example').vectorMap(
{
	...
	scaleColors: ['#b6d6ff', '#00AAAA'],
	selectedColor: '#00AAAA',
	selectedRegions: ['DE', 'US', 'AT', 'CH', 'FR'],
	showTooltip: true,
...
var statisticsChart = new Chart(ctx, {
	...
	data: {
		...
		datasets: [ {
			...
			fill: true,
			borderWidth: 2,
			data: [10, 15, 17, 15, 30, 37, 45, 67, 87, 113, 96, 120]
		}, {
			label: "Neue Spieler",
			borderColor: '#fdaf4b',
			...
			fill: true,
			borderWidth: 2,
			data: [10, 5, 2, 0, 15, 7, 8, 22, 20, 26, 0, 24]
		}, {
			...
			fill: true,
			borderWidth: 2,
			data: [4, 9, 11, 8, 22, 26, 33, 54, 71, 94, 81, 102]
		}]
	},
	options : {
		responsive: true, 
